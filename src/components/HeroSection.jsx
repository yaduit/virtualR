  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        ...
        <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
            Empower your development with VirtualR our intutive devlopement tools designed to streamline your workflow, enhance productivity, and bring your ideas to life in immersive virtual environments.
        </p>
